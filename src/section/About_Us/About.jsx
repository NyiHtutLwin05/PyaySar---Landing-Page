  ...
  return (
    <>
      <div className="my-20 mb-6 " id="about us">
        <div className="flex items-center justify-center gap-5 mt-20 text-4xl text-center lg:gap-14 md:gap-8">
        ...
        <div className="flex justify-center ">
          <div className="flex flex-col items-center justify-center w-[340px] lg:w-[900px] md:w-auto  lg:flex-row md:flex-row ">
